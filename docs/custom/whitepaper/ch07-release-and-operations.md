...
| 목적 | 문서 |
| --- | --- |
| Operator/test surface | [UI, Operator, 테스트와 확장 지점](../30-integration/30-ui-operator-tests-and-extension-points.md) |
| release gate | [개발, 빌드, 테스트 실행 계약](../40-implementation/40-development-build-test-guide.md) |
| 운영 runbook 기준 | [운영, 보안, 관측성 계약](../50-operations/50-operations-security-observability.md) |
| 열린 결정 | [열린 결정 기록](../90-decisions/90-open-decision-register.md) |

## 문서 이동

| 이전 | 다음 | 상위 |
| --- | --- | --- |
| [Ch.6 SPI, Provider, Quarkus 런타임](./ch06-extension-runtime-model.md) | [Ch.8 보안, 감사, 미결 결정과 로드맵](./ch08-security-audit-and-roadmap.md) | [백서 홈](../WHITEPAPER.md) |
